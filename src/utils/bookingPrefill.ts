...
const BOOK_CTA_NOUN: Record<string, string> = {
  ...
  'masonry-installation': 'Masonry Installation',
  'masonry-repair': 'Masonry Repair',
  'masonry-inspection': 'Masonry Inspection',
  'masonry-installs': 'Masonry Installation',
  'masonry-repairs': 'Masonry Repair',
